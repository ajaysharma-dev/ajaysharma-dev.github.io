...
router.get("/me", auth_1.default, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const loggedInUser = yield user_1.default.findById(userId).select("-password");
        if (!loggedInUser) {
...
router.post("/register", [
    ...
    (0, express_validator_1.check)("password", "Password should be of 6 chars or more").isLength({
        min: 6,
    }),
], register);
